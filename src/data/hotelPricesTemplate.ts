...
export const hotelPricesTemplate: Record<string, { price: string; eachPays: string; notes: string }> = {
  "2025-02-20": { price: "374.65 EUR (2 nights)", eachPays: "124.88 EUR", notes: "Free Cancel by 2/18" },
  "2025-02-21": { price: "—", eachPays: "—", notes: "—" },
  "2025-02-22": { price: "165.60 EUR", eachPays: "55.20 EUR", notes: "Free Cancel by 2/19" },
  "2025-02-23": { price: "439.36 EUR (2 nights)", eachPays: "146.45 EUR", notes: "Free Cancel by 2/20" },
  "2025-02-24": { price: "—", eachPays: "—", notes: "—" },
  "2025-02-25": { price: "403.12 EUR (2 nights)", eachPays: "134.37 EUR", notes: "Free Cancel by 2/23" },
  "2025-02-26": { price: "—", eachPays: "—", notes: "—" },
  "2025-02-27": { price: "283.44 EUR (2 nights)", eachPays: "94.48 EUR", notes: "Free Cancel by 2/22" },
  "2025-02-28": { price: "—", eachPays: "—", notes: "—" },
  "2025-03-01": { price: "160.05 EUR", eachPays: "53.35 EUR", notes: "Free Cancel by 1/30" },
  "2025-03-02": { price: "354.39 EUR (2 nights)", eachPays: "118.13 EUR", notes: "Free Cancel by 2/28" },
